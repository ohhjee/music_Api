                        ...
                        <div class="p-3 bg-[rgba(0,0,0,.5)] rounded-sm">
                            <div class="flex justify-between items-center">
                                <div class="flex">
                                    ...
                                    <div class="ml-3 w-6/12 leading-[20px]">
                          ...
                          {{ song.name }}
                            ...
                            <!-- {{song.timer}} -->
                                ...
                                <div id="like">
                                    <div class="" v-if="song.id  == currentSong?.id">
                                        <button id="audio" @click="play()" v-if="!isPlaying" class="h-7 w-7 rounded-full bg-[blue] overflow-hidden flex items-center justify-center">
                                            <i class="fa-solid fa-play text-white flex items-center justify-center w-full"></i>
                                        </button>
                                        <button @click="pause()" v-else class="h-7 w-7 rounded-full bg-[blue] overflow-hidden flex items-center justify-center">
                                            <!-- <i class="fa-solid fa-play text-white flex items-center justify-center w-full"></i> -->
                                            <i class="fa-solid fa-pause text-white flex items-center justify-center w-full"></i>
                                        </button>
                                    </div>
                                    <div class="" v-else>
                                        <button id="audio" @click="play(song)" class="h-7 w-7 rounded-full bg-[blue] overflow-hidden flex items-center justify-center">
                                            <i class="fa-solid fa-play text-white flex items-center justify-center w-full"></i>
                                        </button>
                    ...
                    <div class="items-center flex flex-col space-y-[.5rem] justify-center">
                        <div id="Music_controller" class="flex space-x-[2rem] items-center">
                            <div class="flex flex-row items-center space-x-[2rem]">
                                ...
                                <!-- PREV -->
                                <button @click="prev" class="hidden sm:flex border rounded-full h-7 w-7 items-center justify-center" id="prev">
                        ...
                        <i class="fa-solid fa-play text-white flex items-center justify-center w-full"></i>
                                ...
                                <!-- NEXT -->
                                <div>
                                    <div id="next" @click="next" class="next h-7 w-7 border rounded-full flex items-center justify-center">
...
title.value=currentSong.value?.name
            // name.value = currentSong.value?.[songIndex.value].name;
