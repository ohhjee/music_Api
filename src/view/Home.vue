  ...
  <div>
    ...
    <div class="lg:flex lg:space-x-3 mt-3 lg:mt-0">
      ...
      <div class="w-full relative hidden lg:flex">
        <div
          class="w-full lg:w-8/12 xl:w-7/12 bg-blue-300/40 lg:bg-blue-300/90 h-full rounded-[35px]"
        >
          <div
          ...
          <div class="absolute w-full lg:w-8/12 xl:w-7/12 h-full">
            <div
            ...
            <div
              class="bg-[url('../../assets/images/images/singer.png')] h-full bg-no-repeat bottom-0 left-0 top-0 bg-right-top right-0 absolute w-full"
            ></div>
          </div>
        </div>
              ...
              <div class="flex justify-between items-center">
                <div class="flex">
                  ...
                  <div class="ml-3 leading-[20px]">
                    <div class="text-white text-[17px] font-light">Golden age of 80s</div>
                    <small class="text-gray-300 text-[12px]"> sean swadder </small>
                    <div>
                      <small class="text-white text-[12px]"> 2:34:45 </small>
                    </div>
                  </div>
                </div>
                <div id="like">
              ...
              <div class="flex justify-between sm:items-center">
                <div class="flex flex-col sm:flex-row">
                  ...
                  <div class="mt-2 sm:mt-0 sm:ml-4 leading-[20px]">
                    <div class="text-white text-[17px] font-light title">
                      {{ song.artists[0].name }}
                    </div>
                    <small class="text-gray-300 text-[12px]"> {{ song.name }} </small>
                    <div>
                      <small class="text-white text-[12px]"> 2:34:45</small>
                    </div>
                  </div>
      ...
      <div class="w-full sm:hidden space-y-4 h-full">
        <router-link :to="{ name: 'TopChart' }" class="text-[20px] font-bold text-white">
          Top Charts
        </router-link>
        <div
...
export default defineComponent({
  ...
  setup() {
    ...
    function loadSong() {
      //   title.value = SongData.value.name;
      //   console.log(SongData.value);

      console.log(SongData.value);

      //   name.value = SongData.value.artists.name;
      audio.value.src = SongData.value.preview_url;
    }
